...
const Sidebar = ({ currentPath, onNavigate }) => {
  ...
  return (
    <aside
      className="fixed left-0 top-0 z-40 h-full w-64 flex flex-col border-r border-gray-200 bg-white"
    >
      {/* Brand */}
      <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100">
        ...
        <div className="leading-tight">
          ...
          <p className="text-sm font-bold" style={{ color: NAVY }}>Kota Batu</p>
        </div>
      </div>
              ...
              {items.map((item) => {
                ...
                return (
                  <button
                    ...
                    style={active ? { backgroundColor: `${NAVY}15`, color: NAVY } : {}}
                  >
