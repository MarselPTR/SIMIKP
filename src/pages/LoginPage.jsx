    ...
    <div className="min-h-screen flex">
      ...
      >
        <img
          src={logoKotaBatu}
          alt="Logo Kota Batu"
          className="w-44 h-auto mb-8 drop-shadow-lg"
        />
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              style={{ '--tw-ring-color': '#1a2a6c' }}
              onFocus={(e)  => { e.currentTarget.style.borderColor = '#1a2a6c'; e.currentTarget.style.boxShadow = '0 0 0 2px rgba(26,42,108,0.2)'; }}
