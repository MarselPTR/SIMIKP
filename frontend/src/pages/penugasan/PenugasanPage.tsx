      ...
      try {
        ...
        if (res.data && res.data.length > 0) {
          ...
          return res.data.map((a: any) => ({
            ...
            status: a.status === "COMPLETED" ? "done" : a.status === "IN_PROGRESS" ? "in-progress" : a.status === "CONFLICT" ? "conflict" : "pending",
...
>>>>>>> origin/backend-frontend-connected
    }
    return null;
