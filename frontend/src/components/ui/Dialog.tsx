...
const Dialog = ({ open, onClose, title, children, actions, size = "md" }: DialogProps) => {
  ...
  return createPortal(
    ...
    >
      <div
        className={`relative ${sizes[size]} w-full my-auto bg-white dark:bg-[#161b22] border border-gray-200 dark:border-gray-800 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] transition-colors`}
